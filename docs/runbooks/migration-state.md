...
The production column used to be headed `jajggbeimfudpzcxytbb`. That is the retired hosted
project, not the database production runs on; the readings from 2026-09-12 onwards were taken
