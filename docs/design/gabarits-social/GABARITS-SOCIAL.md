...
| une langue prise pour une autre à cause de son nom — le mythe porte sur l'origine de la langue, pas sur l'existence de son nom, qui reste un mot venu d'une autre langue — *décidé par l'opérateur le 2026-09-21, pour le sujet `swahili-le-nom-de-la-cote`* | un registre de la banque ci-dessous | celui du registre | « Cette langue n'est pas arabe. » | « arabe. » | « Son nom dit où elle se parle, pas d'où elle vient. » — *distinct de la ligne « invention coloniale » ci-dessus : celle-là porte l'acte d'inventer une langue, celle-ci une origine que le nom, un mot arabe (sawāḥil, « côtes »), fait supposer à tort ; distinct aussi de « une langue, une famille » : ici la classification n'est pas en cause, c'est la lecture du nom* |
