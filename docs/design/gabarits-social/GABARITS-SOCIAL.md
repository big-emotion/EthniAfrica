...
| un mot du vocabulaire savant dont les sources datent et nomment l'origine — typologie `mot` — *décidé par l'opérateur le 2026-09-21, pour le sujet `ethnie-d-ou-vient-le-mot`* | un registre de la banque ci-dessous | celui du registre | « Ce mot a un auteur. » | « auteur. » | « Un nom, une date, une phrase : on peut lui demander d'où il vient. » — *le lot **présente** ce que les sources disent (« selon le TLFi… », « Lapouge écrit… ») et n'affirme ni l'antériorité ni un motif que le texte ne porte pas ; « auteur » nomme la personne dont une source attestée porte la proposition, pas l'inventeur exclusif — distinct de « un mot d'usage courant, qui reprend le nom et le titre d'une personne » ci-dessus : celle-là décompose un mot en la titulature d'un homme, celle-ci renvoie un mot savant à la page où il est proposé* |
