...
## Design — the charters and the reviewed renderings

- [Design references — V2 atlas](design/README.md)
- [Actions charter — the four shapes a click is allowed to take](design/actions-charter.md)
- [Atlas charter — what the design system asserts](design/atlas-charter.md)
- [Brand charter — what the atlas is, before it is a page](design/brand-charter.md)
- [Dossier themes and navigation — architecture proposal](design/dossier-theme-architecture-proposal.md)
...
- [Le seuil devient une mesure — 11 septembre 2026](design/gabarits-social/notes/_gabarit-mesure-2026-09-11.md)
- [Révision du gabarit — 11 septembre 2026](design/gabarits-social/notes/_gabarit-revision-2026-09-11.md)
- [§9 bis — la vidéo cesse d'être un carrousel qui bouge](design/gabarits-social/notes/_gabarit-video-2026-09-11.md)
- [Un seul voile, et dix ouvertures — 11 septembre 2026](design/gabarits-social/notes/_gabarit-voile-unique-2026-09-11.md)
- [Moteur de composition A/B/C — 10 septembre 2026](design/gabarits-social/notes/_moteur-composition-2026-09-10.md)
- [Reset des gabarits sociaux — 10 septembre 2026](design/gabarits-social/notes/_reset-2026-09-10.md)
- [La vidéo sur le voile unique — 11 septembre 2026](design/gabarits-social/notes/_video-2026-09-11-voile-unique.md)
- [Portage vidéo du moteur de composition — 11 septembre 2026](design/gabarits-social/notes/_video-2026-09-11.md)
- [Assemblage vidéo — 11 septembre 2026](design/gabarits-social/notes/_video-assemblage-2026-09-11.md)
- [La clôture, et la carte qui la remplaçait](design/gabarits-social/notes/_video-cloture-2026-09-11.md)
- [La carte de fin reprend sa place, et la voix finit où l'image finit](design/gabarits-social/notes/_video-fin-2026-09-11.md)
- [Games charter — what a round is allowed to ask](design/games-charter.md)
...
- [The bilingual glossary](editorial/glossary.md)
- [Locale indexing](editorial/locale-indexing.md)
...
- [Audience audit — 2026-09-07](audience/audit-2026-09-07.md)
...
- [Runbook — self-hosted Plausible Analytics](runbooks/plausible-self-hosted.md)
- [Runbook — production deploy and rollback](runbooks/production-deploy.md)
- [Runbook — regenerating the quiz question bank](runbooks/quiz-bank-regeneration.md)
- [Restore drill — 2025-07-14](runbooks/restore-drill-2025-07-14.md)
- [Restore drill — 2026-09-22](runbooks/restore-drill-2026-09-22.md)
- [Runbook — Supabase restore](runbooks/restore-procedure.md)
- [Runbook — bypassing the `revisions` append-only invariant](runbooks/revisions-dba-bypass.md)
- [Runbook — secret exposure audit of the public history (2026-09-01)](runbooks/secret-exposure-audit-2026-09.md)
- [Runbook — V1 schema removal cutover (2026-05)](runbooks/v1-removal-cutover-2026-05.md)

## Decisions

- [ADR-0007: One textured-sphere globe for the whole atlas](adr/0007-atlas-globe-engine.md)
- [Architecture decision records](adr/README.md)

## Templates

- [Title](templates/jira-ticket-template.md)
