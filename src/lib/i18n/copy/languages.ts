...
const en = {
  pageTitle: "Languages",
  pageSubtitle:
    "The attested languages of Africa, classified by language family. We list 748 languages for 532 distinct names — several languages share the same name (for instance “Fulfulde”, which designates both fuf and fuv), hence the family and the ISO 639-3 identifier shown on every row.",
  unavailable:
    "The languages are temporarily unavailable. Try again in a moment.",
  range: {
    none: "No language",
    of: "of",
