...
const en = {
  ...
  subtitle:
    "We name eight hundred peoples, fifty-four countries and twenty-four language families. Almost none of these names was chosen by those it designates.",
  ...
  missingImposition:
    "We record the origin of an exonym in free prose, never as a value. We can count records that use the word “administration”; we cannot count names that an administration imposed.",
  countryEtymologies:
    "The etymologies of the fifty-four countries are recorded here and backed by no source: the “The country” chapter presents them as a reading, never as a measurement.",
  ...
  vocabularyIntro:
    "Endonym, exonym, glossonym, ethnic reification: this dossier uses words that the site displayed without defining them anywhere. The glossary holds them, each with an example from our entries — or with the reason why we have none.",
