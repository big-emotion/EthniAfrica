  ...
  sections: [
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          text: "Sur la classification de leur propre nom, les fiches disent trois choses. 445 déclarent leur appellation contestée ou héritée de la colonisation. 19 déclarent autre chose. Et 310 ne déclarent rien du tout.",
          sourceRefs: [],
          figureRefs: [
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          text: "Et il reste les 310 fiches muettes. Elles ne disent pas que tout va bien : elles disent que personne n'a encore regardé. C'est la première dette de ce dossier envers son propre corpus.",
          sourceRefs: [],
          figureRefs: ["status-undeclared"],
        },
      ],
