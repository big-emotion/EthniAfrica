  ...
  sections: {
    "la-mesure-et-ce-quelle-ne-mesure-pas": {
      ...
      blocks: {
        ...
        "trois-declarations":
          "On the classification of their own name, the fiches say three things. 445 declare their name contested or inherited from colonisation. 19 declare something else. And 310 declare nothing at all.",
        "le-troisieme-nombre":
    ...
    "ce-que-latlas-en-fait": {
      ...
      blocks: {
        ...
        "les-fiches-muettes":
          "And there remain the 310 silent fiches. They do not say that all is well: they say that nobody has looked yet. That is the first debt this dossier owes to its own corpus.",
      },
    },
  },
  entities: {
