  ...
  legalNotice: {
    ...
    sections: [
      ...
      },
      {
        title: "Hébergement",
        paragraphs: [
          "Le site est hébergé {host}. Les serveurs de l’application et de la base de données sont situés dans l’Union européenne.",
        ],
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Les préférences de consentement sont enregistrées dans le stockage local du navigateur pour mémoriser les choix effectués (voir « Cookies et stockage local »).",
          "L’adresse IP d’une requête adressée à l’API publique ou au formulaire de contact sert à limiter le nombre de requêtes (voir « Services et sous-traitants »).",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "La mesure d’audience Plausible n’est activée qu’après consentement. La lecture d’une production tierce sur le site repose sur votre consentement, recueilli au moment où vous la demandez. Les diagnostics techniques strictement nécessaires à la sécurité et à la stabilité peuvent être traités au titre de l’intérêt légitime.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Microsoft Corporation, par son service Microsoft Graph, envoie les courriels du site : lien de connexion, notifications de modération adressées aux contributeurs, et messages du formulaire de contact transmis à l’éditeur. Ces courriels transitent par ses serveurs avec l’adresse de leur destinataire, et sont conservés au repos par Microsoft, dans le locataire Microsoft 365 de l’éditeur, dans l’Union européenne (à ce jour, en France).",
          "Upstash, Inc. et Microsoft Corporation sont des sociétés de droit américain : un accès depuis les États-Unis, ou un transfert de ces données vers ce pays, n’est pas exclu, même si le compteur d’Upstash et les courriels conservés par Microsoft sont situés dans l’Union européenne. Les serveurs de l’éditeur, eux, y sont aussi situés.",
          "Lorsque vous demandez la lecture d’une production sur le site, le lecteur de YouTube est chargé depuis youtube-nocookie.com, fourni par Google Ireland Limited. Cette lecture n’a lieu qu’après une action explicite de votre part : aucune requête n’est adressée à Google tant que vous ne l’avez pas demandée. Google reçoit alors votre adresse IP, les caractéristiques de votre navigateur et le contexte de lecture, et écrit sur votre appareil, selon sa propre politique, du stockage local et des cookies. Lors de notre dernière vérification, le lecteur a tenté d’écrire deux cookies : « TESTCOOKIESENABLED », qui d’après son nom vérifie que le navigateur accepte les cookies, et « LAST_RESULT_ENTRY_KEY », dont le nom reprend celui d’une clé de stockage local du lecteur. Selon votre navigateur, ces cookies sont refusés d’office ou enregistrés. Ce traitement relève de Google en tant que responsable distinct ; ses durées de conservation sont les siennes et ne sont pas fixées par EthniAfrica. Il implique un transfert hors de l’Union européenne, encadré par les clauses contractuelles types et le cadre de protection des données UE–États-Unis. Votre choix est conservé douze mois et révocable à tout moment depuis « Gestion des cookies ». Chaque production reste accessible directement sur la plateforme où elle est publiée, sans passer par le lecteur.",
          "Les cinq formulaires « Documenter une entrée en détail », proposés sur la page Contribuer, sont hébergés par Google Forms, un service de Google Ireland Limited. Ils ne s’ouvrent que si vous suivez leur lien. Ce que vous y saisissez, y compris votre adresse de courriel si le formulaire la demande, est transmis à Google et conservé avec les réponses du formulaire dans le compte Google de l’éditeur, qui les relit avant toute publication. Ce traitement peut impliquer un transfert hors de l’Union européenne, encadré par les clauses contractuelles types et le cadre de protection des données UE–États-Unis.",
